"""
Django settings for job_posting_backend project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'http://job-highway-backend-production.up.railway.app', 'https://job-highway-backend-production.up.railway.app']
...
ROOT_URLCONF = 'job_posting_backend.urls'
